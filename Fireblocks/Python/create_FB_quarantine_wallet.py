...
VAULT_NAME = "My ETH Vault" # Please specify
ASSET_ID = "ETH"  # Ethereum asset ID
DEPOSIT_DESC = "Client A ETH quarantine address"
...
if addresses:
    print(f"ETH quarantine Address: {addresses[0]['address']}")
else:
    print("No quarantine address found — wallet creation may still be processing.")
